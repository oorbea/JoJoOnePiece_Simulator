...
const vector<Stand> standArray = {
    ...
    Stand("Holy's Stand", "Te mueres"),
    Stand("Jonathan's Stand", "Rastrea a tu familia"),
    Stand("Tower of Gray", "La mosca"),
    Stand("Dark Blue Moon", "Stand tipo maritimo. el que los persigue en el barco en s3. tiene escamas i percebes que cortan."),
    Stand("Strength", "Tienes un barco muy grande que puedes controlar"),
    Stand("Ebony Devil", "tienes un titere asesino que solo funciona si estas muy enfadado"),
    Stand("Yellow Temperance", "Tienes un líquido dorado que te permite adoptar la forma de otras personas u objetos, y el líquido es indestructible prácticamente."),
    Stand("Hanged Man", "puedes atacar desde dentro de los reflejos apuñalando a la gente, se desplaza como un rayo de luz de reflejo en reflejo"),
    Stand("Emperor", "revolver con balas dirigibles"),
    Stand("Empress", "es un tumor que te crece en el cuerpo y se va haciendo grande y te pega y te va quitando energia y te devora hasta hacer un traje contigo"),
    Stand("Wheel of Fortune", "tienes un carricoche to wapo"),
    Stand("Justice", "es una niebla que puede crear ilusiones y puede hacer agujeros en las heridas que permiten controlar partes del cuerpo de las personas hasta que tiene suficientes agujeros para controlarlo por completo"),
    Stand("Lovers", "se te mete en el cerebro por el oido y te hace daño, sin mas"),
    Stand("Sun", "genera un sol raro que hace mucho calor y quema un poco"),
    Stand("Death Thirteen", "invades los sueños de la gente y los atacas con tu stand que tiene una guadaña. Las heridas se mantienen al despertar pero se olvida todo lo que ha pasado. el stand se puede usar si se activa antes de dormirse"),
    Stand("Judgement", "es un stand fisico que no refleja los daños a su usuario que concede deseos creandolos con barro que perjudican al que los pide"),
    Stand("High Priestess", "se puede transformar en cualquier objeto hecho de minerales o metales. puede aprisionar gente dentro de su boca, sus dientes son tan duros como el diamante"),
    Stand("Geb", "es una masa pequeña de agua que no refleja el daño a su usuario. puede ahogar a la gente y desgarrar en la forma de mano. se le puede quemar. es a larga distancia."),
    Stand("Khnum", "permite transformarse en otra persona, el olor tambien"),
    Stand("Tohth", "un comic que muestra el destino inevitable, aunque se puede interpretar de varias maneras"),
    Stand("Anubis", "una espada que te posee y te controla. es un espadachin muy tocho. puede elegir que cortar y que no a lo largo de la espada, literalmente atraviesa objetos la espada"),
    Stand("Bastet", "pones un enchufe y si lo tocas te vuelves un iman muy potente y se te van enganchando cosas hasta que el usuario este ko o muy lejos"),
    Stand("Sethan", "si pisas la sombra del usuario rejuveneces muy rapido, retrocediendo tambien tu estado mental. puede atacarte tambien su sombra. se acaba al estar ko"),
    Stand("Osiris", "si apuestas con el usuario y admites la derrota en tu corazon pierdes tu alma las almas que no se recuperen en las apuestas se pierden"),
    Stand("Horus", "pajarraco de hielo que dispara pinchos de hieloy congela"),
    Stand("Atum", "puedes hacer preguntas de si o no a las almas i saber si mienten. si pierden en un juego contra ti les robas el alma"),
    Stand("Tenore Sax", "puedes hacer que una casa parezca mas grande i que sea como un laberinto. Si te sale este stand es One Piece directo. no lo digo yo, es la regla del stand"),
    Stand("Cream", "te metes dentro de ti mismo y desgarras el espacio. el que mata a avdol. dentro de tu boca no ves nada, hay q asomar para ver"),
    Stand("The World", "ORE WA DIO-SAMA"),
    ...
    Stand("Bad Company", "Bad Company es un grupo de soldados de juguete que se despliegan desde la mano de su usuario. Cada soldado es armado con un arma de fuego y es capaz de disparar a su objetivo."),
    Stand("Red Hot Chili Pepper", "Red Hot Chili Pepper es capaz de absorber electricidad para usarla como energía para muchas cosas, como aumentar de su fuerza, su velocidad, curar sus heridas, levitar, y cubrirse en una capa eléctrica."),
    Stand("The Lock", "Al hacer que alguien se sienta culpable, el usuario puede conectar al stand a la persona y hacer que se sienta pesada y le cueste moverse."),
    Stand("Surface", "La Habilidad principal de Surface es copiar el aspecto de otra persona. Surface sólo puede usar esta habilidad mientras está de pie cara a cara con la persona original que está copiando"),
    Stand("Love Deluxe", "Love Deluxe está integrado al cabello de su usuario, lo que le permite crecer a diversas longitudes y moverse con una fuerza y destreza considerable"),
    Stand("Pearl Jam", "El stand hace que la comida sepa increíble y tenga propiedades curativas."),
    Stand("Achtung Baby", "Permite a su usuario volverse invisible."),
    Stand("Ratt", "Ratt puede disparar balas de púas, que se derretirá cualquier cosa sobre el impacto para que se deforme como la gelatina o la arcilla."),
    Stand("Harvest", "Tiene muchísimas unidades pequeñas que pueden recolectar objetos y dinero."),
    Stand("Cinderella", "Cinderella es un Stand que se comporta de manera idéntica a su portadora, es decir, es un Stand enfocado únicamente y exclusivamente en la estética y en modificar la apariencia de la persona."),
    Stand("Atom Heart Father", "Atom Heart Father se activa cuando alguien toma una fotografía y éste se encuentra allí. Puede manipular todo lo que se encuentre dentro del espacio fotografiado."),
    Stand("Boy II Man", "Si te gana a una partida de piedra, papel o tijera, te drena la energía vital."),
    Stand("Earth Wind and Fire", "Permite al usuario transformarse en objetos inanimados."),
    Stand("Highway Star", "El stand tiene la habilidad de correr a velocidades extremas, si te pilla, te aspira los nutrientes."),
    Stand("Stray Cat", "Stray Cat tiene la habilidad de manipular el aire. Es capaz de crear burbujas de aire comprimido lo suficientemente fuertes para golpear a una persona dejándola inconsciente"),
    Stand("Super Fly", "No puedes abandonar una torre de alta tensión a menos que alguien entre en ella."),
    Stand("Enigma", "Enigma es capaz de sellar objetos y personas, incluido el usuario, en papel."),
    Stand("Cheap Trick", "Si alguien ve la espalda de su usuario, este muere y el stand se le pega a la espalda y si alguien más ve la espalda de esa persona, se le pega a él."),
    Stand("Killer Queen", "", true),


    //Parte 5
    Stand("Gold Experience", "", true),
    Stand("Sticky Fingers", "La habilidad principal de Sticky Fingers es crear cremalleras en cualquier superficie que toque con sus puños, las cuales puede abrir y cerrar cuando lo desee"),
    Stand("Moody Blues", "La habilidad principal de Moody Blues es repetir el pasado de cualquier cosa o cualquier persona en un lugar determinado"),
    Stand("Sex Pistols", "Su usuario puede ordenar a cada miembro de Sex Pistols para disparar a diferentes direcciones e incluso rebotar en los objetos o detenerlos una vez dentro de su objetivo. el uso más común de Mista de esto es para rebotar dentro, para la destrucción de sus órganos vitales."),
    Stand("Aerosmith", "Aerosmith es un pequeño avión que está equipado con dos ametralladoras pequeñas en sus alas y una bomba debajo del fuselaje para atacar a los enemigos"),
    Stand("Purple Haze", "Purple Haze es un Stand orientado al combate a corta distancia, pero lo que hace realmente peligroso al Stand es el contenido vírico almacenado en las seis cápsulas, que matan al contacto a cualquier ser vivo."),
    Stand("Spice Girl", "Cuando Spice Girl golpea un objeto, este adquiere una consistencia parecida al caucho muy suave."),
    Stand("Mr.President", "Es una tortuga capaz de llevar a objetos y personas en la habitación que contiene en su caparazón."),
    Stand("Black Sabbath", "Cuando se vuelve a prender el encendedor de su usuario, Black Sabbath se materializa en una sombra cerca de la víctima, para después ir velozmente hacia ella y perforar su alma o su Stand con la flecha, matando a la víctima o concediéndole un Stand si este es apto."),
    Stand("Soft Machine", "Como sólo necesita una puñalada para desinflar completamente a sus víctimas, la habilidad desconcertante de Soft Machine hace que sus emboscadas sean temibles. Pero una vez al aire libre, sus habilidades de combate cuerpo a cuerpo mediocres son claras."),
    Stand("Kraft Work", "Kraft Work tiene el control sobre los vectores cinéticos de todo lo que toca."),
    Stand("Little Feet", "Little Feet puede encoger a cualquier persona u objeto cortándolos con su dedo índice."),
    Stand("Man in the Mirror", "Posee la habilida de entrar en una dimensión alterna dentro de un espejo."),
    Stand("Beach Boy", "Es una caña de pescar que puede atravesar cualquier cosa y atraer a cualquier cosa que toque."),
    Stand("The Grateful Dead", "The Grateful Dead demostró ser un Stand lo suficientemente fuerte como para mantener a Sticky Fingers a raya, aunque su velocidad y su precisión no son muy buenas, la característica principal de The Grateful Dead es la de hacer envejecer a todo lo que esté en su rango. Esta habilidad no respeta entre aliados o enemigos afectándolos por igual."),
    Stand("Baby Face", "A través de un ordenador, puede embarazar a una mujer y crear un Stand a partir de su hijo."),
    Stand("White Album", "Tiene forma de traje de patinaje sobre hielo que lo va congelando todo y protege a su usuario de los ataques."),
    Stand("Clash", "Es un pequeño tiburón capaz de nadar a través de cualquier cuerpo acuoso y arrancar partes del cuerpo de su víctima."),
    Stand("Talking Head", "Talking Head es un Stand Automático extremadamente frágil cuyas cualidades de lucha son más bien pobres; no obstante el punto fuerte de Talking Head es su cualidad para forzar a sus enemigos a decir mentiras."),
    Stand("Notorious B.I.G", "Mediante la muerte de su usuario, se transforma en una gran masa carnosa invencible que persigue a sus rivales a la misma velocidad a la que se mueven."),
    Stand("Metallica", "Metallica puede manipular el hierro en el cuerpo de las personas a distancia."),
    Stand("Green Day", "El stand puede hacer que cualquier cosa que esté por debajo de su usuario se pudra."),
    Stand("Oasis", "Permite a su usuario nadar por superficies sólidas."),
    Stand("Rolling Stones", "La habilidad de Rolling Stones es convertirse en la de la víctima destinada a morir y la perseguirá para dejarlo morir pacíficamente. Sin embargo, si la víctima resiste con suficiente fuerza, y Rolling Stones se rompe, la víctima será condenada a morir de manera dolorosa y Rolling Stones dejará de perseguirlos."),
    Stand("King Crimson", "King Crimson puede predecir el futuro y borrar el tiempo, dejando solo los resultados de sus actos. Además de esto, cuenta con súper fuerza."),
